use doris_rust_stream_load::{Client, Config, Handle, LogLevel, Mode, ValidationMode};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    headers.insert("x-custom-header", HeaderValue::from_static("rust-example"));
